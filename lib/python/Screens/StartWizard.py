...
config.misc.do_overscanwizard = ConfigBoolean(default=OverscanWizard and config.misc.do_overscanwizard = ConfigBoolean(default=OverscanWizard and config.skin.primary_skin.value == "Pd1loi-HD-night/skin.xml")
